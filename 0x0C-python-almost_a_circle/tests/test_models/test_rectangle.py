...
class TestRectangle_order_of_initialization(unittest.TestCase):
    ...
    def test_widthbeforeheight(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle("invalid width", "invalid height")

    def test_widthbeforex(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle("invalid width", 2, "invalid x")

    def test_widthbeforey(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle("invalid width", 2, 3, "invalid y")

    def test_heightbeforex(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Rectangle(1, "invalid height", "invalid x")

    def test_heightbeforey(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
...
class TestRectangle_area(unittest.TestCase):
    ...
    def test_areachangedattributes(self):
        r = Rectangle(2, 10, 1, 1, 1)
        r.width = 7
        r.height = 14
        self.assertEqual(98, r.area())

    def test_areaonearg(self):
        r = Rectangle(2, 10, 1, 1, 1)
        with self.assertRaises(TypeError):
            r.area(1)
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def test_display_widthheight(self):
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargssomewrongkeys(self):
        r = Rectangle(10, 10, 10, 10, 10)
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionaryoutput(self):
        r = Rectangle(10, 2, 1, 9, 5)
        correct = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'width': 10}
        self.assertDictEqual(correct, r.to_dictionary())

    def test_to_dictionarynoobjectchanges(self):
        r1 = Rectangle(10, 2, 1, 9, 5)
        r2 = Rectangle(5, 9, 1, 2, 10)
        r2.update(**r1.to_dictionary())
        self.assertNotEqual(r1, r2)

    def test_to_dictionaryarg(self):
